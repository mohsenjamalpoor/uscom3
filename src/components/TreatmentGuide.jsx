    ...
    noradrenaline: {
      ...
      getRecommendation: () => {
        if (
          ...
          shouldShowRecommendation([svri, map]) &&
          svri < 800 &&
          map < 65
        ) {
          ...
          return {
            ...
            rationale: `SVR پایین (${svri}), MAP پایین (${map}) و وضعیت `,
            priority: 1,
          };
        }
        if (
    ...
    adrenaline: {
      ...
      getRecommendation: () => {
        if (
          ...
          shouldShowRecommendation([ci, smii]) &&
          ci < 1.8 &&
          smii < 1.0
        ) {
        ...
        if (
          ...
          shouldShowRecommendation([spO2, do2]) &&
          spO2 < 90 &&
          do2 < 300
        ) {
      ...
      getRecommendation: () => {
        if (
          ...
          return {
            text: "شروع میلرینون",
            dose: getDoseText(dose, "mcg/min"),
            rationale: `SMII پایین (${smii}) با SVR بسیار بالا (${svri})`,
            priority: 1,
          };
        }
